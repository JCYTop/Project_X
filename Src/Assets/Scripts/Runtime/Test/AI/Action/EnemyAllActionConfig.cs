...
namespace GOAP
{
    public class EnemyAllActionConfig : ActionConfig<ActionEnemyTag, ActionCommonElementTag>
    {
        public List<EnemyAllActionUnit> allAction = new List<EnemyAllActionUnit>();

        public override SortedList<ActionEnemyTag, ActionConfigUnit<ActionCommonElementTag>> Init()
        {
            var actionSort = new SortedList<ActionEnemyTag, ActionConfigUnit<ActionCommonElementTag>>();

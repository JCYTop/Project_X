...
namespace Ludiq.PeekCore
{
	public class PluginConfiguration : IPluginModule, IEnumerable<PluginConfigurationItemAccessor>
	{
		...
		[MenuItem("Tools/Peek/Ludiq/Internal/Delete All Project Settings", priority = LudiqProduct.InternalToolsMenuPriority + 401)]
		...
		[MenuItem("Tools/Peek/Ludiq/Internal/Delete All Editor Prefs", priority = LudiqProduct.InternalToolsMenuPriority + 402)]
		...
		[MenuItem("Tools/Peek/Ludiq/Internal/Delete All Player Prefs", priority = LudiqProduct.InternalToolsMenuPriority + 403)]

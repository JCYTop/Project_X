...
namespace Sirenix.OdinInspector.Demos
{
    ...
    public class DefaultDrawerChanges : MonoBehaviour
    {
        ...
        [InfoBox(
            "All vector fields are responsive, meaning that labels are removed when the inspector is narrow. This can be disabled in the Odin Preferences window.")]
        [InfoBox(
        ...
        [InfoBox(
            "All object fields now have a small pen icon that when left-clicked opens the object in a new, locked inspector window. You can also do this through the right-click context menu, if the drawing of the object field itself is changed by a custom drawer." +
